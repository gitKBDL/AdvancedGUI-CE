...
export const checks: { [key: string]: CheckMeta } = {
  ...
  [ListNextCheck.legacyId]: ListNextCheck,
  [PlaceholderCheck.numberId]: {
    id: PlaceholderCheck.numberId,
    component: PlaceholderCheck.component,
    generator: PlaceholderCheck.numberGenerator,
    fromJson: PlaceholderCheck.fromJson,
  },
