...
export function placeRemoteImage(
  ...
  imageUrl = imageUrl
    .replace(/%UUID_U%/g, "00000000000000000000000000000000")
  ...
  if (resImage.dataset.lastUrl !== imageUrl) {
    delete resImage.dataset.noCors;
    resImage.dataset.lastUrl = imageUrl;
  }

  if (resImage.dataset.noCors) {
    resImage.removeAttribute("crossorigin");
  } else {
