  ...
  <div class="toolbar">
    <div class="zoom">
      ...
      <div
        ...
        :title="t('toolbar.snapToggle', 'Toggle snapping')"
    ...
    <div class="historyControls row">
      <div
        class="btnHstr"
        :class="
          history.stack.length <= history.historyIndex + 1 ? 'inactive' : ''
        "
        @click.stop="undo"
      >
      ...
      <div
        class="btnHstr"
        :class="history.historyIndex != 0 ? '' : 'inactive'"
        @click.stop="redo"
      >
